...
function nameCheck(name){
  if (name === 'Steven'){
    ...
    return (`Cool name, ${name}`)        // return 'Cool name' + name
  }
}
let nameGreeting = nameCheck('Chuck')
...
////////////////// PROBLEM 7 ////////////////////
let namesArr = ['Cameron', 'Riley', 'Eric', 'Brenna', 'Karl','Jake']
/*
...
allUpperCase('Hi, my name is Kylo')
...
function emailCheck(email){
  ...
  if (email.includes('@')){
    ...
    return 'Most provide a valid email address'
  }
}
let emailTest = emailCheck('connor@gmail.com')
...
function bestBuy(goldToSpend){
  let numFrogs = goldToSpend / 3
  return numFrogs
}
totalFrogs = bestBuy(100)
...
totalFrogs2 = bestBuy2(151)
console.log(totalFrogs2)
//Math.floor could also be used
...
let arrayIsAscending = examineArray(sampleArray)
